...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	44c50513          	addi	a0,a0,1100 # 7e0 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 464:	380b8b93          	addi	s7,s7,896 # 7e0 <digits>
 ...
 5a4:	23890913          	addi	s2,s2,568 # 7d8 <malloc+0xf2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66c:	1907b783          	ld	a5,400(a5) # 7f8 <freep>
 ...
 69a:	00e6ea63          	bltu	a3,a4,6ae <free+0x50>
{
 ...
 6dc:	12f73023          	sd	a5,288(a4) # 7f8 <freep>
}
 6e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70e:	0ee53503          	ld	a0,238(a0) # 7f8 <freep>
 ...
 736:	0c690913          	addi	s2,s2,198 # 7f8 <freep>
  if(p == (char*)-1)
 73a:	5afd                	li	s5,-1
 73c:	a88d                	j	7ae <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 73e:	00000797          	auipc	a5,0x0
 742:	0c278793          	addi	a5,a5,194 # 800 <base>
 746:	00000717          	auipc	a4,0x0
 74a:	0af73923          	sd	a5,178(a4) # 7f8 <freep>
 74e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 770:	08a73623          	sd	a0,140(a4) # 7f8 <freep>
      return (void*)(p + 1);
